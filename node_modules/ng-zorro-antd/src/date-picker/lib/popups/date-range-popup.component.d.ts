...
export declare class DateRangePopupComponent implements OnInit, OnChanges {
    ...
    private overrideTimeOptions(origin, value, partial?);
    private setValue(value);
    private overrideHms(from, to);
    private isValidRange(value);
    private normalizeRangeValue(value);
    private sortRangeValue(key);
    private setRangeValue(key, partType, value);
    private cloneRangeDate(value);
    private initialArray(key);
}
