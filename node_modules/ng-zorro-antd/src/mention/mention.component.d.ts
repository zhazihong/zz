...
export declare class NzMentionComponent implements OnDestroy, AfterContentInit {
    ...
    constructor(document: any, ngZone: NgZone, overlay: Overlay, viewContainerRef: ViewContainerRef);
    ...
    private suggestionsFilter(value, emit);
    private resetDropdown(emit?);
